...
public class BusyBox extends ViewOwner {
    ...
    public View createUI()
    {
        ...
        lview.setFont(new Font("Arial", 15));
        lview.setRowHeight(30);
        ...
        items.add("Buttons");
        vbox.addChild(createButtonsView());
        System.out.println("BusyBox createUI 3");
        items.add("Toggle Buttons");
        vbox.addChild(createToggleButtonsView());
        items.add("CheckBoxes");
        vbox.addChild(createCheckBoxsView());
        System.out.println("BusyBox createUI 4");
        items.add("RadioButtons");
        vbox.addChild(createRadioButtonsView());
        items.add("Sliders");
        vbox.addChild(createSlidersView());
        System.out.println("BusyBox createUI 5");
        items.add("TextFields");
        vbox.addChild(createTextFieldsView());
        items.add("ProgressBar");
        vbox.addChild(createProgressBarView());
        ...
        sview2.setGrowWidth(true);
        sview2.setGrowHeight(true);
        RowView top = new RowView();
        top.addChild(new Label("SnapKit BusyBox"));
        ...
        bview.setPrefSize(800, 600);
        bview.setCenter(sview2);
        bview.setLeft(sview1);
        bview.setTop(top);
    ...
    public View createButtonsView()
    {
        ...
        btn2.setPadding(2, 2, 2, 2);
        Button btn3 = new Button("Button Three");
        btn3.setPadding(2, 2, 2, 2);
        RowView hbox = new RowView();
        hbox.setAlign(Pos.CENTER);
        hbox.setSpacing(20);
        ...
        RowView hbox2 = new RowView();
        hbox2.setAlign(Pos.CENTER);
        hbox2.setSpacing(20);
        ...
        vbox.setSpacing(30);
        vbox.setChildren(label, hbox, hbox2);
        vbox.setBorder(VIEW_BORDER);
        vbox.setFont(VIEW_FONT);
        return vbox;
    }
    ...
    public View createToggleButtonsView()
    {
        ...
        ToggleButton btn1 = new ToggleButton("Align Left");
        btn1.setGroupName("TG1");
        btn1.setPrefWidth(100);
        ToggleButton btn2 = new ToggleButton("Align Center");
        btn2.setGroupName("TG1");
        btn2.setPrefWidth(100);
        ToggleButton btn3 = new ToggleButton("Align Right");
        btn3.setGroupName("TG1");
        ...
        ToggleButton btn1a = new ToggleButton("1");
        btn1a.setPadding(2, 12, 2, 12);
        btn1a.setPosition(Pos.CENTER_LEFT);
        ToggleButton btn2a = new ToggleButton("2");
        btn2a.setPadding(2, 12, 2, 12);
        btn2a.setPosition(Pos.CENTER);
        ToggleButton btn3a = new ToggleButton("3");
        btn3a.setPadding(2, 12, 2, 12);
        btn3a.setPosition(Pos.CENTER_RIGHT);
        btn1a.setGroupName("g1");
        btn2a.setGroupName("g1");
        btn3a.setGroupName("g1");
        btn1a.setPrefWidth(50);
        btn2a.setPrefWidth(50);
        btn3a.setPrefWidth(50);
        btn1a.setSelected(true);
        RowView hbox3 = new RowView();
        hbox3.setAlign(Pos.CENTER); //hbox.setSpacing(20);
        hbox3.setChildren(btn1a, btn2a, btn3a);


        ColView col = new ColView();
        col.setAlign(Pos.CENTER);
        col.setPadding(20, 20, 20, 20);
        col.setSpacing(30);
        col.setChildren(label, vbox, hbox3);
        col.setBorder(VIEW_BORDER);
        col.setFont(VIEW_FONT);
    ...
    public View createCheckBoxsView()
    {
        ...
        vbox.setPadding(20, 20, 20, 20);
        vbox.setSpacing(20);
        vbox.setChildren(label, btn1, btn2, btn3);
        vbox.setBorder(VIEW_BORDER);
        vbox.setFont(VIEW_FONT);
        return vbox;
    }
    ...
    public View createRadioButtonsView()
    {
        ...
        RadioButton btn1 = new RadioButton("RadioButton One");
        btn1.setGroupName("TG2");
        RadioButton btn2 = new RadioButton("RadioButton Two");
        btn2.setGroupName("TG2");
        RadioButton btn3 = new RadioButton("RadioButton Three");
        btn3.setGroupName("TG2");
        ColView vbox = new ColView();
        vbox.setAlign(Pos.CENTER);
        vbox.setPadding(20, 20, 20, 20);
        vbox.setSpacing(20);
    ...
    public View createSlidersView()
    {
        ...
        sldr1.setPrefWidth(200);
        TextField text1 = new TextField();
        text1.setText("0");
        text1.setPrefWidth(50);
        text1.setAlign(Pos.CENTER);
        sldr1.addEventHandler(e -> text1.setText(fmt.format(sldr1.getValue())), Action);
        RowView hbox1 = new RowView();
        hbox1.setChildren(lbl1, sldr1, text1);

        Label lbl2 = new Label("Slider Two:");
        Slider sldr2 = new Slider();
        sldr2.setPrefWidth(200);
        TextField text2 = new TextField();
        text2.setText("0");
        text2.setPrefWidth(50);
        text2.setAlign(Pos.CENTER);
        sldr2.addEventHandler(e -> {
            double v = sldr2.getValue();
            text2.setText(fmt.format(v));
            text2.setScale(1 + v);
        }, Action);
        RowView hbox2 = new RowView();
        hbox2.setChildren(lbl2, sldr2, text2);

        Label lbl3 = new Label("Slider Three:");
        Slider sldr3 = new Slider();
        sldr3.setPrefWidth(200);
        TextField text3 = new TextField();
        text3.setText("0");
        text3.setPrefWidth(50);
        text3.setAlign(Pos.CENTER);
        sldr3.addEventHandler(e -> {
            double v = sldr3.getValue();
            text3.setText(fmt.format(v));
            text3.setRotate(v * 360);
        }, Action);
        RowView hbox3 = new RowView();
        hbox3.setChildren(lbl3, sldr3, text3);

        ColView vbox = new ColView();
        vbox.setAlign(Pos.CENTER);
        vbox.setPadding(30, 30, 30, 30);
        vbox.setSpacing(30);
        vbox.setChildren(label, hbox1, hbox2, hbox3);
        vbox.setBorder(VIEW_BORDER);
        vbox.setFont(VIEW_FONT);
        return vbox;
    }
    ...
    public View createTextFieldsView()
    {
        ...
        TextField sldr1 = new TextField();
        sldr1.setPrefWidth(200);
        RowView hbox1 = new RowView();
        hbox1.setChildren(lbl1, sldr1);
        Label lbl2 = new Label("TextField Two:");
        TextField sldr2 = new TextField();
        sldr2.setPrefWidth(200);
        RowView hbox2 = new RowView();
        hbox2.setChildren(lbl2, sldr2);
        Label lbl3 = new Label("TextField Three:");
        TextField sldr3 = new TextField();
        sldr3.setPrefWidth(200);
        RowView hbox3 = new RowView();
        hbox3.setChildren(lbl3, sldr3);
        ColView vbox = new ColView();
        vbox.setAlign(Pos.CENTER);
        vbox.setPadding(30, 30, 30, 30);
        vbox.setSpacing(30);
    ...
    public View createTabView()
    {
        ...
        tabView.setPrefSize(400, 220);
        tabView.addTab("Primary", new Label("This stuff comes first"));
        tabView.getTab(0).getContent().setAlign(Pos.CENTER);
        tabView.addTab("Secondary", new Label("This stuff comes next"));
        tabView.getTab(1).getContent().setAlign(Pos.CENTER);
        tabView.addTab("Tertiary", new Label("This stuff comes last"));
        tabView.getTab(2).getContent().setAlign(Pos.CENTER);
        ColView colView = new ColView();
        colView.setAlign(Pos.CENTER);
        colView.setPadding(20, 20, 20, 20);
        colView.setSpacing(20);
        colView.setChildren(label, tabView);
        colView.setBorder(VIEW_BORDER);
        colView.setFont(VIEW_FONT);
        return colView;
    }
